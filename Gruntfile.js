...
var electronShell = {
  windows: {
    ...
    renamedExe:  "clo-bubbles.exe",
    resources:   "resources",
    installExt:  "exe"
  },
  mac: {
    exeToRename: "Electron.app",
    renamedExe:  "clo-bubbles.app",
...
function copyElectronAndBuildToRelease(build, paths) {
  grunt.log.writeln("\nCopying Electron and clo-bubbles to release folder...");
...
function finalizeMacRelease(build, paths) {
  ...
  exec("defaults write " + plist + " CFBundleDisplayName clo-bubbles");
  exec("defaults write " + plist + " CFBundleName clo-bubbles");
